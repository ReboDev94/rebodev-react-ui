...
export const VARIANTS_CHECKBOX = [VARIANT_PRIMARY, VARIANT_ERROR, VARIANT_BASE] as const;
...
export const WRAPPER_CHECKBOX_CLASSES = 'relative flex items-center cursor-pointer';
